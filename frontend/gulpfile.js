...
gulp.task('copyAddonsStyles', function() {
    ...
    var aStyle59 = gulp.src(['node_modules/bootstrap-table/dist/bootstrap-table.min.css'])
        .pipe(gulp.dest('./vendors/bootstrap-table'));
    return merge(aStyle1, aStyle2, aStyle3, aStyle4, aStyle5, aStyle6, aStyle7, aStyle8, aStyle9, aStyle10, aStyle15, aStyle16, aStyle17, aStyle18, aStyle19, aStyle20, aStyle21, aStyle22, aStyle23, aStyle24, aStyle25, aStyle26, aStyle27, aStyle28, aStyle29, aStyle30, aStyle31, aStyle32, aStyle33, aStyle34, aStyle35, aStyle36, aStyle37, aStyle38, aStyle39, aStyle40, aStyle49, aStyle50, aStyle51, aStyle52, aStyle53, aStyle54, aStyle56, aStyle57,aStyle58,aStyle59);
});
...
// bundle the vendors then move the css,js,fonts,images,pages and index.html and vendors all to the dist folder. call this task 'build'
gulp.task('build', gulp.series('bundleVendors', function() {
    var moveCss = gulp.src(['./css/**/*'])
        .pipe(gulp.dest('./dist/css'));
    var moveJs = gulp.src(['./js/**/*'])
        .pipe(gulp.dest('./dist/js'));
    var moveFonts = gulp.src(['./fonts/**/*'])
